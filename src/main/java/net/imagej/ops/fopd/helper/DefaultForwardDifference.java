 ...
 * @param <T>
 */
@Plugin(type = ForwardDifference.class, description = "Forward difference for dimension d.", priority = Priority.HIGH_PRIORITY)
public class DefaultForwardDifference<T extends RealType<T>>
