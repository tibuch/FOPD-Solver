 ...
 * implement {@link Abstract2DDescent#doDescent(SolverState, int)} which then
 * will be called for each view.
 * 
 * @author Tim-Oliver Buchholz, Universtiy of Konstanz
 * @param <T>
 */
public abstract class Abstract2DDescent<T extends RealType<T>> extends
